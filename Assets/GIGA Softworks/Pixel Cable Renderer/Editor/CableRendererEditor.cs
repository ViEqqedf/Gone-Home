...
namespace GIGA.PixelCableRenderer.Editor
{
	...
	public class CableRendererEditor : UnityEditor.Editor
	{
		...
		public static void DrawResizingHandles(CableRenderer renderer,bool hasDirection = false)
		{
			...
			Vector3 leftEdge = Handles.FreeMoveHandle(prevLeftEdge, Quaternion.identity, size, snap, CableRendererSettings.GetUnityHandle((CableRendererSettings.SupportedHandleType)EditorPrefs.GetInt(CableRendererSettings.SETTING_STRING_HANDLETYPE, 0)));
			Handles.color = hasDirection ? Color.red : Color.green;
			Vector3 rightEdge = Handles.FreeMoveHandle(prevRightEdge, Quaternion.identity, size, snap, CableRendererSettings.GetUnityHandle((CableRendererSettings.SupportedHandleType)EditorPrefs.GetInt(CableRendererSettings.SETTING_STRING_HANDLETYPE, 0)));
